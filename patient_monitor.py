...
# Suppress overly verbose logs from noise-prone libraries:
logging.getLogger("picamera2").setLevel(logging.WARNING)
logging.getLogger("libcamera").setLevel(logging.WARNING)
logging.getLogger("onnxruntime").setLevel(logging.WARNING)
logging.getLogger("numba").setLevel(logging.WARNING)
logging.getLogger("simplejpeg").setLevel(logging.WARNING)
...
# ==== Audio recording and speech functions ====
...
def alert_interaction(oid, boundary_side):
    ...
    speak(f"Are you okay? I noticed you're near the {boundary_side} side of the bed. Please say okay if you are fine, or help if you need assistance.")
